...
import 'package:women_safety/widgets/rounded_button.dart';
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              btnTxt!,
              style:
                  sfProStyle600SemiBold.copyWith(color: textWhiteColor! ? AppColors.whiteColorLight : AppColors.black, fontSize: fontSize),
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
                child: Text(
              btnTxt!,
              style: sfProStyle600SemiBold.copyWith(color: textColor, fontSize: fontSize),
              textAlign: TextAlign.center,
            )),
            isShowRightIcon! ? Icon(rightIcon(context), color: isStroked! ? Colors.red : Colors.white) : const SizedBox.shrink()
          ],
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Row(
        ...
        children: [Icon(backIcon(context), color: Colors.white), Text(title)],
      ),
    );
  }
}
